...
## Temporal Test Splits & Model Training
...
## Metric Collecting with Bootstrapping
...
Third, stepping away from looking at this through the lens of a competition leaderboard, it's worth noting that MLM's winner by MAE didn't have the best ranking power by Kendall tau (see tables below), although they would overlap in their CI ranges. In situations like prioritizing synthesis efforts if you have more designs than fume hoods - MAE may not be the most ideal metric. Practical interpertation is, however, highly contextual. (Apologies to Pat Walters for the dreaded bolded tables presentation :)) 
